...
### Final Check for your PR

Now that you have the **README**, the **PR description**, and the **fixed code**, you are ready to merge.

**Is there anything else you need—like a `.gitignore` file to keep the `.o` and `.log` files out of your repo—or are you ready to ship it?**
